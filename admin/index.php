...
<head>
  <meta charset="UTF-8">
  <title>Discovery Chitral ||  Admin Sign IN</title>
   <link rel="shortcut icon" href="assets/images/wed-21-10-2020-19-48-50-128x128-1.png" type="image/x-icon">
...
<body>
  ...
  <div class="bottom" style="padding:150px 0;">  
      ...
      <div id="login">
        ...
        <form method="post">
          ...
          <fieldset class="clearfix">
            ...
            <p><input type="submit" name="sub" style="background-color: #F9AD81; cursor: pointer;" value="Login"></p>
