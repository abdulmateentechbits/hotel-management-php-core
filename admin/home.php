        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="settings.php"><i class="fa fa-gear"></i> Room Setting</a>
                    </li>
                    <li>
                        <a href="payment.php"><i class="fa fa-money"></i> Payment</a>
                    </li>
                     <li>
                        <a  href="#"><i class="fa fa-bar-chart-o"></i> Tour Booking</a>
                    </li>
                    <li>
                        <a  href="usersetting.php"><i class="fa fa-user"></i> Users</a>
                    </li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table">
									...
									<?php
									$tsql = "select * from roombook where stat='Not Confirm'";
