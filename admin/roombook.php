												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														...
														{	$notfree="NotFree";
															...
															{
															echo "<script type='text/javascript'> alert('Hurray! Booking Confirmed')</script>";
...
include('../user/db_conn.php');			
	...
	if(isset($_POST['co']))
						{	
							...
							if($st1=="Reject")
							{
									$urb1 = "DELETE FROM roombook WHERE id = '$id'";
									$Rejt=  mysqli_query($conn,$urb1);

								if ($Rejt) {
									
									echo "<script type='text/javascript'> alert('Booking Cancel And delete Successfully')</script>";
								}
