...
<head>
    ...
    <title>Discovery Chitral  || Tour Booking</title>
    <!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="booking.php"><i class="fa fa-bar-chart-o"></i>Hotel Bookings</a>
                    </li>
                    <li>
                        <a class="active-menu" href="tour_booking.php"><i class="fa fa-bar-chart-o"></i>Tour Bookings</a>
                    </li>
                    <li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    $id=$row["id"];
                                    $tsql = "select * from tour_request where user_id='$id'";
                                    $tre = mysqli_query($con,$tsql);
                                    ...
                                    {   
                                            ...
                                            echo"<tr>
                                                ...
                                                <th>".$trow['pdate']."</th>"
?>
                                                <th><a class="btn btn-primary" href="#" role="button"><?php echo $trow['status']  ?></a></th>
                                               
                                                <th><a class="btn btn-success" href="tour_invoice.php?sid=<?php echo $trow['req_id']  ?>" role="button">Print</a></th>
                                                 <th><a class="btn btn-danger" href="cancel_request.php?sid=<?php echo $trow['req_id']  ?>" role="button">Cancel</a></th>
                                                </tr>
                                                <?php                                    
                                    }
                                    ?>
...
if(isset($_POST['search'])) {
  ...
  else
  {
    ...
    $search = "SELECT *FROM roombook WHERE req_id = '".$id."' AND status = 'confirm'";
