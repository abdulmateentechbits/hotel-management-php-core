	...
	?>
		<header>
			...
			<address >
				...
				<p>Hotel Booking<br>Chitral.</p>
				<p>(+92) 345 2117099</p>
			</address>
			<span style="margin-top: 25px;"><img alt="" src="#"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- Itizaz Ur Rehman || Web :- www.discovery chitral .com || Phone :- +92 345 2117099 </p>
			</div>
		</aside>
	</body>
</html>
